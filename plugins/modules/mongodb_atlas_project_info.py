...
"""mongodb_atlas_project_info module."""
...
short_description: Retrieve atlas project information
description:
    - Retrieve details about atlas projects.
    - Read-only module.
version_added: "1.0.0"
author:
...
- name: Get a specific atlas project
  stevefulme1.mongodb.mongodb_atlas_project_info:
    host: api.example.com
...
def main():
    ...
    if resource_id:
        result = client.get("atlas_project", resource_id)
        ...
        resources = client.list("atlas_project", module.params)

    module.exit_json(changed=False, atlas_projects=resources)
