...
"""mongodb_atlas_restore_info module."""
...
DOCUMENTATION = r"""
---
module: mongodb_atlas_restore_info
short_description: Retrieve atlas restore information
description:
    - Retrieve details about atlas restores.
    - Read-only module.
version_added: "1.0.0"
author:
...
EXAMPLES = r"""
- name: List all atlas restores
  stevefulme1.mongodb.mongodb_atlas_restore_info:
    host: api.example.com
  register: result

- name: Get a specific atlas restore
  stevefulme1.mongodb.mongodb_atlas_restore_info:
    host: api.example.com
...
def main():
    ...
    if resource_id:
        result = client.get("atlas_restore", resource_id)
        ...
        resources = client.list("atlas_restore", module.params)

    module.exit_json(changed=False, atlas_restores=resources)
