...
"""mongodb_atlas_alert_info module."""
...
DOCUMENTATION = r"""
---
module: mongodb_atlas_alert_info
short_description: Retrieve atlas alert information
description:
    - Retrieve details about atlas alerts.
    - Read-only module.
version_added: "1.0.0"
author:
...
EXAMPLES = r"""
- name: List all atlas alerts
  stevefulme1.mongodb.mongodb_atlas_alert_info:
    host: api.example.com
  register: result

- name: Get a specific atlas alert
  stevefulme1.mongodb.mongodb_atlas_alert_info:
    host: api.example.com
...
def main():
    ...
    if resource_id:
        result = client.get("atlas_alert", resource_id)
        ...
        resources = client.list("atlas_alert", module.params)

    module.exit_json(changed=False, atlas_alerts=resources)
